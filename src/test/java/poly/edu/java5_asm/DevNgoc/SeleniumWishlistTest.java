    ...
    public void testAddToWishlist_Success() {
        try {
            ...
            for (WebElement card : productCards) {
                try {
                    WebElement wishlistBtn = card.findElement(By.className("product-card__wishlist-btn"));
            ...
            boolean isActive = updatedClasses.contains("active");
            ...
            System.out.println("   ✓ Wishlist count: " + initialCount + " → " + newCount);
            assertTrue("Wishlist count should increase", newCount > initialCount);
    ...
    public void testRemoveFromWishlist_Success() {
        try {
            ...
            if (wishlistCards.isEmpty()) {
                ...
                WebElement wishlistBtn = firstProduct.findElement(By.className("product-card__wishlist-btn"));
                wishlistBtn.click();
                Thread.sleep(2000);
            ...
            List<WebElement> updatedCards = driver.findElements(By.className("wishlist-card"));
            assertTrue("Wishlist should have fewer items", updatedCards.size() < wishlistCards.size());
            System.out.println("   ✓ Items count: " + wishlistCards.size() + " → " + updatedCards.size());
            
            int newCount = getWishlistCount();
            System.out.println("   ✓ Wishlist count: " + initialCount + " → " + newCount);
            assertTrue("Wishlist count should decrease", newCount < initialCount);
